...
from .lifter_helper import ParseError, StopParsing
...
class Instruction:
    ...
    def parse(self, bitstrm):
        ...
        # This is the point of no return. If this fails then stop parsing.
        try:
            ...
            return data
        except (ParseError, bitstring.ReadError) as e:
            raise StopParsing from e
