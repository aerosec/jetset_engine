...
class CFGNode(object):
    ...
    __slots__ = ( 'addr', 'simprocedure_name', 'syscall_name', 'size', 'no_ret', 'is_syscall', 'function_address',
                  ...
                  '_hash','callstack','_callstack_key',
                  )
    ...
    def __init__(self,
        ...
        self._callstack_key = self.mk_callstack_key()
    ...
    def mk_callstack_key(self):
        s = ""
        for addr in self.callstack:
            s += hex(addr)
        return s
    ...
    def copy(self):
        c = CFGNode(self.addr,
                    ...
                    callstack = copy.deepcopy(self.callstack),
                    _callstack_key = self._callstack_key
                    )
        return c
    ...
    def __eq__(self, other):
        ...
        return (self.addr == other.addr and
                ...
                self.simprocedure_name == other.simprocedure_name and 
                self._callstack_key == other._callstack_key
                )

    def __hash__(self):
        if self._hash is None:
            self._hash = hash((self._callstack_key, self.addr, self.simprocedure_name, ))
        return self._hash
